...
const CrewAllowanceManagementPage = lazy(() => import('@/pages/CrewAllowanceManagementPage'));
...
const CashTransactionEditPage = lazy(() => import('@/pages/CashTransactionEditPage'));
...
export const routeConfig: RouteEntry[] = [
  ...
  { path: '/management-fee-invoice/:ownerId/:yearMonth', component: ManagementFeeInvoiceViewPage },
  ...
  { path: '/crew-allowance-management', component: CrewAllowanceManagementPage },
  ...
  { path: '/accounting/cashbook/transaction/:id', component: CashTransactionEditPage },
  { path: '/accounting/expense-reflection', component: AccountingExpenseReflectionPage },
