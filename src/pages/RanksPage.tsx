                ...
                {permissions.canCreate && (
                  <Dialog open={isDialogOpen} onOpenChange={(open) => {
                    ...
                    <DialogContent className="max-w-md">
                      <DialogHeader>
                        <DialogTitle className="text-base">{editingRank ? '직급 수정' : '직급 추가'}</DialogTitle>
                        <DialogDescription className="text-sm">직급 정보를 입력하세요</DialogDescription>
                      </DialogHeader>
                          ...
                          <Table>
                            ...
                            <TableBody>
                              {departmentRanks.map((rank, index) => (
                                <TableRow key={rank.id} className="hover:bg-gray-50/50">
