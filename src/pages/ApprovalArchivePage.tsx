...
import { CheckCircle2, XCircle, Search, User, Ship, Calendar, ChevronLeft, ChevronRight, ArrowLeft } from 'lucide-react';
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="flex items-center gap-3 mb-4">
          <Button variant="ghost" size="sm" onClick={() => { setViewMode('list'); setSelected(null); }}>
            <ArrowLeft className="w-4 h-4 mr-1" />뒤로
          </Button>
          <div>
            <h1 className="text-2xl font-bold">결재 문서 상세</h1>
          </div>
        </div>
          ...
          <div className="space-y-2">
            {paginated.map(approval => (
              <Card
                ...
                onClick={() => { setSelected(approval); setViewMode('detail'); }}
              >
