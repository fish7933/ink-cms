                    ...
                    <table className="w-full text-xs whitespace-nowrap">
                      <thead className="bg-gray-50 border-b">
                        <tr>
                          ...
                          {cat === 'standby' && <th className="px-2 py-2 text-center font-medium text-gray-600">상태</th>}
                      ...
                      <tbody>
                        {paginated.length === 0 ? (
                          <tr><td colSpan={(DATE_COLUMN_LABELS[cat].col2 ? 15 : 14) + (cat === 'registered' ? 1 : 0) + (cat === 'standby' ? 1 : 0)} className="text-center py-8 text-sm text-gray-400">선원이 없습니다</td></tr>
                        ) : paginated.map((c, idx) => {
