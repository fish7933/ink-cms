...
import { Plus, Search, Filter, AlertTriangle, Eye, UserPlus, Users } from 'lucide-react';
          ...
          <Table>
            ...
            <TableBody>
              {currentPostings.map((posting) => {
                return (
                  <TableRow key={posting.id} className="hover:bg-muted/50">
                    ...
                    <TableCell className="py-2">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleViewRecommendations(posting)}
                        className="h-7 px-2"
                      >
